...
//
//    @Override
//    public V get(Object key) { return baseEdge.get(key); }
//
//    @Override
...
//
///**
// * Placeholder (either linked or array based) for {@link Vertex} or {@link Edge} itself.
// *
// * @param <K> the type of keys maintained by this map
// * @param <V> the type of mapped values
// */
...
//        }
//
//        int getLevelZeroMask() { return mask; }
//        int getBitCount() { return bitCount; }
//        int getMaxRotation() { return maxRotation;}
//
