...
public class LCAOnBT {
	public static void main(String[] args) {
		...
		BTNode<String> lca = findLCAOnBinaryTree(rt, one, two, new AtomicInteger(0));
		Result lca1 = findLCAOnBinaryTreeNew(rt, one, two);
		System.out.println(lca);
		System.out.println(lca1);
	}
	
	public static BTNode findLCAOnBinaryTree(BTNode<String> root, BTNode<String> one, BTNode<String> two, AtomicInteger noOfNodesFound) {
		if(root == null) {
			return root;
		}
...
//		}
	...
	public static Result findLCAOnBinaryTreeNew(BTNode<String> root, BTNode<String> one, BTNode<String> two) {
	    ...
	    return new Result(numTargetNodes, (numTargetNodes == 2 ? root : 
